...
class DescribeRandomTiler:
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                EXTERNAL_SVS.COLON_1,
                BiggestTissueBoxMask(),
                (200, 200),
                2,
                "red",
                False,
                "tiles-location-images/external-colon-1-random-BTB-false-200x200",
            ...
            pytest.param(
                ...
                "red",
                True,
                "tiles-location-images/external-colon-1-random-BTB-true-200x200",
                marks=pytest.mark.skipif(not on_ci(), reason="To run only on CI"),
            ),
            pytest.param(
                EXTERNAL_SVS.COLON_1,
                ...
                "red",
                False,
                "tiles-location-images/external-colon-1-random-TM-false-200x200",
                marks=pytest.mark.skipif(not on_ci(), reason="To run only on CI"),
            ),
            pytest.param(
                EXTERNAL_SVS.COLON_1,
                ...
                "red",
                True,
                "tiles-location-images/external-colon-1-random-TM-true-200x200",
                marks=pytest.mark.skipif(not on_ci(), reason="To run only on CI"),
            ),
        ],
    )
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            pytest.param(
                ...
                2,
                False,
                "tiles-location-images/external-colon-1-grid-BTB-false-200x200",
                marks=pytest.mark.skipif(not on_ci(), reason="To run only on CI"),
            ),
            pytest.param(
                EXTERNAL_SVS.COLON_1,
                ...
                2,
                True,
                "tiles-location-images/external-colon-1-grid-BTB-true-200x200",
                marks=pytest.mark.skipif(not on_ci(), reason="To run only on CI"),
            ),
            pytest.param(
                EXTERNAL_SVS.COLON_1,
                ...
                2,
                False,
                "tiles-location-images/external-colon-1-grid-TM-false-200x200",
                marks=pytest.mark.skipif(not on_ci(), reason="To run only on CI"),
            ),
            pytest.param(
                EXTERNAL_SVS.COLON_1,
                ...
                2,
                True,
                "tiles-location-images/external-colon-1-grid-TM-true-200x200",
                marks=pytest.mark.skipif(not on_ci(), reason="To run only on CI"),
            ),
            pytest.param(
                EXTERNAL_SVS.COLON_1,
                ...
                1,
                True,
                "tiles-location-images/external-colon-1-grid-TM-true-100x100",
                marks=pytest.mark.skipif(not on_ci(), reason="To run only on CI"),
            ),
        ],
    )
