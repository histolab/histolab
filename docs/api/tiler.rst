Tiler
====================================
Different logics are implemented for tile extraction in the ``tiler`` module. The constructor of the three extractors `RandomTiler <tiler.html#histolab.tiler.RandomTiler>`_, `GridTiler <tiler.html#histolab.tiler.GridTiler>`_, and `ScoreTiler <tiler.html#histolab.tiler.ScoreTiler>`_ share a similar interface and common parameters that define the extraction design:
