...
In particular, the `NucleiScorer <scorer.html#src.histolab.scorer.NucleiScorer>`_ estimates the presence of nuclei in an H&E-stained tile and assigns a higher score to tiles with more nuclei.
